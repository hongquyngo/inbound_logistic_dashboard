...
class InvoiceService:
    ...
    def validate_invoice_with_po_level(df: pd.DataFrame) -> Tuple[Dict, Dict]:
        ...
        # Check single entity (support both old and new column names)
        entity_col = 'legal_entity_code' if 'legal_entity_code' in df.columns else 'consignee_code'
        ...
        # Check vendor type consistency (support both old and new column names)
        vtype_col = 'vendor_type' if 'vendor_type' in df.columns else 'vendor_location_type'
